...
<ul>
    ...
    <li><a href="${pageContext.request.contextPath}/disease/list" class="active">Diseases</a></li>
...
<table>
    ...
    <c:forEach items="${diseases}" var="disease">
        <tr>
            ...
            <td>
                <a href="${pageContext.request.contextPath}/disease/edit/${disease.id}.html">Edit</a><br/>

            </td>
            <td>
                <a href="${pageContext.request.contextPath}/disease/delete/${disease.id}.html">Delete</a><br/>
            </td>
        </tr>
    </c:forEach>
    </tbody>
...
<p>
    <a href="${pageContext.request.contextPath}/disease/add">Add Disease</a>
</p>
</body>
</html>